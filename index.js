...
mongoose.connect("mongodb://0.0.0.0:27017/book", {useNewUrlParser:true, useUnifiedTopology: true } )
.then(()=>{
...
let categories =["education","action","fun"]; // for selected preferences in editing product
